        ...
        <div class="rounded-2xl bg-white px-5 py-4 shadow-sm border border-gray-100">
          <div class="flex items-start justify-between">
            ...
            <div class="flex flex-col items-end">
              ...
              <button class="mt-3 rounded-xl bg-[#e9fffc] px-6 py-3 text-[12px] sm:text-[16px] font-bold text-[#18b8b0] hover:bg-[#bdf5ed] hover:text-[#03645f]" @click="router.push('/add-funds')">
                Add Funds
              </button>
            </div>
          </div>
