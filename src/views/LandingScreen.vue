      ...
      <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:items-center">
        ...
        <div class="sm:order-1">
          ...
          <div class="mt-5 grid gap-3 sm:max-w-[240px]">
            <button type="button" class="flex items-center rounded-xl bg-slate-950 px-4 py-3 text-xs font-normal text-white shadow-lg shadow-slate-950/15 sm:px-5 sm:py-4 sm:text-sm" @click="enterFullscreen().then(() => router.push('/login'))">
              <span class="flex-1">Get Started</span>
              <Icon icon="mdi:arrow-right" class="size-5" />
            </button>
            <button type="button" class="rounded-xl border-[2px] border-slate-950 bg-white px-4 py-3 text-xs font-normal text-slate-950 sm:px-5 sm:py-4 sm:text-sm" @click="enterFullscreen().then(() => router.push('/register'))">
              Sign Up Free
            </button>
          </div>
        </div>
